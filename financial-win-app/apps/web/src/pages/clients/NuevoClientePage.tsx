...
export const NuevoClientePage: React.FC = () => {
  ...
  const handleGuardarYNuevo = () => {
    // TODO: Implementar lógica de guardar y nuevo
    console.log('Guardar y Nuevo');
  };

  const handleGuardarYSalir = () => {
    // TODO: Implementar lógica de guardar y salir
    navigate('/clients');
  };
            ...
            >
              ...
              <div className="form-grid-2">
                <div className="input-group">
                  ...
                  <select id="cuenta-contable" className="input-group-select">
                ...
                <div className="input-group">
                  ...
                  <select id="contrapartida" className="input-group-select">
                ...
                <div className="input-group form-grid-full">
                  ...
                  <select id="clave-operacion-347" className="input-group-select">
            ...
            >
              ...
              <div className="form-grid-2">
                ...
                <div className="input-group">
                  ...
                  <select id="forma-pago-default" className="input-group-select">
            ...
            >
              ...
              <div className="form-grid-2">
                ...
                <div className="input-group">
                  ...
                  <select id="sector" className="input-group-select">
