        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
          {[
            ...
            <button 
              ...
              className="flex items-center gap-4 p-4 rounded-xl bg-white dark:bg-secondary-800 border border-gray-200 dark:border-secondary-border shadow-card hover:shadow-lg hover:-translate-y-1 transition-all duration-200 group text-left"
            >
              <div className={`p-3 rounded-lg ${kpi.color} group-hover:scale-110 transition-transform`}>
                <span className="material-symbols-outlined text-xl">{kpi.icon}</span>
              </div>
              <span className="font-bold text-sm text-neutral-900 dark:text-white">{kpi.label}</span>
              <span className="material-symbols-outlined text-gray-400 ml-auto opacity-0 group-hover:opacity-100 transition-opacity">
